 ...
 */
final class Version20240923052223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4C13CC7880E95E18 ON fiche (demande_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_4C13CC7880E95E18 ON fiche');
