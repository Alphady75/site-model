 ...
 */
final class Version20240924132227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D8698A7680E95E18 ON document (demande_id)');
        $this->addSql('ALTER TABLE questionnaire ADD demande_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D8698A7680E95E18 ON document');
